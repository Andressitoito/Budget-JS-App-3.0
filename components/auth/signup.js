				...
				<div className="flex">
					<div className="w-1/2 text-center px-2">
						<div className="bg-msk-300 rounded-lg flex items-center justify-center border border-indigo-500 outline-2 shadow-lg shadow-violet-200">
							...
							<div className="w-2/3 bg-msk-200 txt-msk-900 md:h-20 h-26 flex flex-col items-center justify-center px-1 rounded-r-lg body-step">
								<h2 className="font-bold md:text-sm text-md">Personal Info</h2>
								<p className="text-sm text-gray-600">Just your personal information</p>
							</div>
						</div>
					</div>
