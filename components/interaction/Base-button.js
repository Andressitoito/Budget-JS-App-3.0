const BaseButton = (props) => {
	...
	const padding = (props.p_xs && "py-1 px-1.5") || (props.p_xl && "py-4 px-4") || "";

	const width = (props.w_full && 'w-full') || (props.w_half && 'w-1/2') || (props.w_quarter && 'w-1/4')
	...
	return (
		<button disabled={props.disabled === true ? true : false}
