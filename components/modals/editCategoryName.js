...
const EditCategoryName = () => {
	const { modalEditCategoryName } = useSelector((state) => state);
	...
	return (
		<>
			<Modal show={modalEditCategoryName} size="md" popup={true} onClose={onClose} className="backdrop-blur-sm pt-[15%] md:pt-0 h-[100%]">
