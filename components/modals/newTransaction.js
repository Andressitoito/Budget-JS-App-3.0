  ...
  >
   <Modal.Body className="bg-msk-800 py-7 p-5 gap-3 rounded-md">
    ...
    <div className="mb-2 block">
     <label htmlFor="itemName" className="block mb-2 font-medium md:text-lg text-3xl txt-msk-300">Item Name</label>
    ...
    <div className="mb-2 block">
     <label htmlFor="price" className="block mb-2 font-medium md:text-lg text-3xl  txt-msk-300">Price</label>
