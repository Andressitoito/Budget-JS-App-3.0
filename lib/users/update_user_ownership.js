...
export const update_user_ownership = async (user_id, organization, new_organization_id) => {
 try {
  ...
  throw new Error(`Something went wrong updating user ownership. ${error.toString()}`)
 }
};
